...
const SubmitDataAlert = ({ isOpen, onClose, onConfirm }) => {
    ...
    return (jsxRuntime.jsx(react$1.AlertDialog, { isOpen: isOpen, onClose: onClose, leastDestructiveRef: cancelRef, isCentered: true, id: "rsi", motionPreset: "none", children: jsxRuntime.jsx(react$1.AlertDialogOverlay, { children: jsxRuntime.jsxs(react$1.AlertDialogContent, { children: [jsxRuntime.jsx(react$1.AlertDialogHeader, { fontSize: "lg", fontWeight: 500, children: translations.alerts.submitIncomplete.headerTitle }), jsxRuntime.jsx(react$1.AlertDialogBody, { children: allowInvalidSubmit
