        ...
        formatter: ({ row, onRowChange }) => {
            ...
            switch (column.fieldType.type) {
                case "checkbox":
                    ...
                    break;
                case "select":
                    component = (jsx(Box, { minWidth: "100%", minHeight: "100%", overflow: "hidden", textOverflow: "ellipsis", children: ((_a = column.fieldType.options.find((option) => option.value === row[column.key])) === null || _a === void 0 ? void 0 : _a.label) || null }));
                    break;
                default:
            ...
            if ((_b = row.__errors) === null || _b === void 0 ? void 0 : _b[column.key]) {
                return (jsx(Tooltip, { placement: "top", hasArrow: true, label: (_d = (_c = row.__errors) === null || _c === void 0 ? void 0 : _c[column.key]) === null || _d === void 0 ? void 0 : _d.message, children: component }));
            }
            return component;
        },
        cellClass: (row) => {
